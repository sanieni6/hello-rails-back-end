...
This is a web application where you can randomly get a greeting from an API. Hello Rails React is an exercise to setup RoR + React. In this part of the project is created the API.
...
### Link to FrontEnd repo <a name="live-demo-link"></a>
[React FrontEnd repo](https://github.com/sanieni6/hello-react-front-end)
...
```sh
  git clone git@github.com:sanieni6/hello-rails-back-end.git
